...
const Header = props => (
  <header className="pr-header absolute top-0 left-0 right-0 pt4 ph4 ph5-l flex justify-between items-center monospace ttu">
    <Link to="/" className="black">
      Jeff Lupinski
    </Link>
    <div className="db">Selected works [17 &mdash; 21]</div>
    ...
    <div className="dn dib-ns">
      <div className="cf inline-flex items-center mr2 relative">
        <svg
